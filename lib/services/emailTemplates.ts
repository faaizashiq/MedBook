                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        <td style="padding:36px 32px;">
                            <h2 style="margin:0 0 12px; font-size:22px;">Appointment request submitted</h2>
                            <p style="margin:0 0 24px; color:#526581; font-size:15px; line-height:1.6;">Hi {{patient_name}},</p>
                            <p style="margin:0 0 24px; color:#526581; font-size:15px; line-height:1.6;">
                                Your appointment request has been successfully submitted. The appointment is currently waiting for confirmation from the doctor.
                            </p>
                            <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                style="background:#f8fafc; border:1px solid #e2e8f0; border-radius:12px;">
                                <tr>
                                    <td style="padding:20px;">
                                        <p style="margin:0 0 8px; font-size:13px; color:#64748b;">DOCTOR</p>
                                        <p style="margin:0 0 18px; font-size:17px; font-weight:bold;">Dr. {{doctor_name}}</p>
                                        <p style="margin:0 0 6px; font-size:14px;"><strong>Date:</strong> {{appointment_date}}</p>
                                        <p style="margin:0 0 6px; font-size:14px;"><strong>Time:</strong> {{appointment_time}}</p>
                                        <p style="margin:0; font-size:14px;"><strong>Status:</strong> <span style="color:#d97706; font-weight:bold;">Pending</span></p>
                                    </td>
                                </tr>
                            </table>
                            <p style="margin:24px 0 0; color:#526581; font-size:14px; line-height:1.6;">
                                You'll receive another email once the doctor confirms or declines your appointment.
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:24px 32px; background:#f8fafc; text-align:center;">
                            <p style="margin:0 0 8px; font-size:13px; color:#64748b;">© {{current_year}} MedBook</p>
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        <td style="padding:36px 32px;">
                            ...
                            <p style="margin:0 0 24px; color:#526581; font-size:15px; line-height:1.6;">
                                Great news! Dr. {{doctor_name}} has confirmed your appointment. Your appointment is now scheduled.
                            </p>
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#f8fafc; border:1px solid #e2e8f0; border-radius:12px;">
                                <tr>
                                    <td style="padding:22px;">
                                        <p style="margin:0 0 8px; font-size:12px; color:#64748b; text-transform:uppercase;">Doctor</p>
                                        <p style="margin:0 0 20px; font-size:18px; font-weight:bold; color:#172b4d;">Dr. {{doctor_name}}</p>
                                        ...
                                        <p style="margin:0 0 8px; font-size:14px; color:#526581;"><strong>Clinic:</strong> {{clinic_address}}</p>
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px; width:100%; background:#ffffff; border-radius:16px; overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:36px 32px;">
                            ...
                            <p style="margin:0 0 24px; color:#526581; font-size:15px; line-height:1.6;">
                                This is a friendly reminder that your appointment with Dr. {{doctor_name}} is scheduled to begin in approximately one hour.
                            </p>
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#f8fafc; border:1px solid #e2e8f0; border-radius:12px;">
                                <tr>
                                    <td style="padding:22px;">
                                        <p style="margin:0 0 8px; font-size:12px; color:#64748b; text-transform:uppercase;">Upcoming Appointment</p>
                                        <p style="margin:0 0 20px; font-size:18px; font-weight:bold; color:#172b4d;">Dr. {{doctor_name}}</p>
                                        <p style="margin:0 0 8px; font-size:14px; color:#526581;"><strong>Date:</strong> {{appointment_date}}</p>
                                        <p style="margin:0 0 8px; font-size:14px; color:#526581;"><strong>Time:</strong> {{appointment_time}}</p>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="margin-top:24px;">
                                <tr>
                                    <td align="center" style="background:#2563eb; border-radius:8px;">
                                        <a href="{{dashboard_url}}" style="display:inline-block; padding:12px 22px; color:#ffffff; text-decoration:none; font-size:14px; font-weight:bold;">View Appointment</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        <td style="padding:36px 32px;">
                            ...
                            <p style="margin:0 0 20px; color:#526581; font-size:15px; line-height:1.6;">Hi Dr. {{doctor_name}},</p>
                            <p style="margin:0 0 24px; color:#526581; font-size:15px; line-height:1.6;">
                                You have received a new appointment booking request from <strong>{{patient_name}}</strong>. Please review the details below and confirm or decline the appointment from your dashboard.
                            </p>
                            <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                style="background:#f8fafc; border:1px solid #e2e8f0; border-radius:12px;">
                                <tr>
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px; width:100%; background:#ffffff; border-radius:16px; overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:36px 32px;">
                            ...
                            <p style="margin:0 0 20px; color:#526581; font-size:15px; line-height:1.6;">Hi {{recipient_name}},</p>
                            <p style="margin:0 0 24px; color:#526581; font-size:15px; line-height:1.6;">
                                Your appointment with Dr. {{doctor_name}} has been cancelled by {{cancelled_by}}.
                            </p>
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#f8fafc; border:1px solid #e2e8f0; border-radius:12px;">
                                <tr>
                                    <td style="padding:22px;">
                                        <p style="margin:0 0 8px; font-size:12px; color:#64748b; text-transform:uppercase;">Appointment</p>
                                        <p style="margin:0 0 20px; font-size:18px; font-weight:bold; color:#172b4d;">Dr. {{doctor_name}}</p>
                                        <p style="margin:0 0 8px; font-size:14px; color:#526581;"><strong>Date:</strong> {{appointment_date}}</p>
                                        <p style="margin:0 0 8px; font-size:14px; color:#526581;"><strong>Time:</strong> {{appointment_time}}</p>
                                        <p style="margin:0; font-size:14px; color:#526581;"><strong>Status:</strong> <span style="display:inline-block; padding:4px 10px; background:#fef3c7; color:#92400e; border-radius:999px; font-size:12px; font-weight:bold;">CANCELLED</span></p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="margin-top:24px;">
                                <tr>
                                    <td align="center" style="background:#2563eb; border-radius:8px;">
                                        <a href="{{dashboard_url}}" style="display:inline-block; padding:12px 22px; color:#ffffff; text-decoration:none; font-size:14px; font-weight:bold;">View Dashboard</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px; width:100%; background:#ffffff; border-radius:16px; overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:36px 32px;">
                            ...
                            <p style="margin:0 0 20px; color:#526581; font-size:15px; line-height:1.6;">Hi {{patient_name}},</p>
                            <p style="margin:0 0 24px; color:#526581; font-size:15px; line-height:1.6;">
                                Unfortunately, Dr. {{doctor_name}} was unable to accept your appointment request.
                            </p>
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#f8fafc; border:1px solid #e2e8f0; border-radius:12px;">
                                <tr>
                                    <td style="padding:22px;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:20px; background:#fff7ed; border:1px solid #fed7aa; border-radius:12px;">
                                <tr>
                                    <td style="padding:18px 20px;">
                                        <p style="margin:0 0 8px; font-size:13px; font-weight:bold; color:#9a3412;">Reason</p>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="margin-top:24px;">
                                <tr>
                                    <td align="center" style="background:#2563eb; border-radius:8px;">
                                        <a href="{{doctors_url}}" style="display:inline-block; padding:12px 22px; color:#ffffff; text-decoration:none; font-size:14px; font-weight:bold;">Find Another Doctor</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px; width:100%; background:#ffffff; border-radius:16px; overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:36px 32px;">
                            ...
                            <p style="margin:0 0 20px; color:#526581; font-size:15px; line-height:1.6;">Hi {{recipient_name}},</p>
                            <p style="margin:0 0 24px; color:#526581; font-size:15px; line-height:1.6;">
                                Your appointment with Dr. {{doctor_name}} has been rescheduled. Please review the updated appointment details below.
                            </p>
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#f8fafc; border:1px solid #e2e8f0; border-radius:12px;">
                                <tr>
                                    <td style="padding:22px;">
                                        <p style="margin:0 0 8px; font-size:12px; color:#64748b; text-transform:uppercase;">Updated Appointment</p>
                                        <p style="margin:0 0 20px; font-size:18px; font-weight:bold; color:#172b4d;">Dr. {{doctor_name}}</p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:20px; background:#f8fafc; border:1px solid #e2e8f0; border-radius:12px;">
                                <tr>
                                    <td style="padding:18px 20px;">
                                        <p style="margin:0 0 8px; font-size:13px; font-weight:bold; color:#64748b;">Previous Appointment</p>
                                        <p style="margin:0 0 6px; font-size:14px; color:#526581;"><strong>Previous Date:</strong> {{previous_appointment_date}}</p>
                                        <p style="margin:0; font-size:14px; color:#526581;"><strong>Previous Time:</strong> {{previous_appointment_time}}</p>
                                    </td>
                                </tr>
                            </table>
                            <table cellpadding="0" cellspacing="0" border="0" style="margin-top:24px;">
                                <tr>
                                    <td align="center" style="background:#2563eb; border-radius:8px;">
                                        <a href="{{dashboard_url}}" style="display:inline-block; padding:12px 22px; color:#ffffff; text-decoration:none; font-size:14px; font-weight:bold;">View Updated Appointment</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
